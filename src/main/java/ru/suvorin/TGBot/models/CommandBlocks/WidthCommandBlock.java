...
public class WidthCommandBlock extends CommandBlock {
    private final RequestService requestService;

    public WidthCommandBlock(String command, String text, String answerText, UserState requiredUserStateForAnswer, RequestService requestService, InlineKeyboardButton... buttons) {
    ...
    public String handleAnswer(long chatId, UsersStateBlock userStatesBlock, String answer) {
        ...
        request.setWidth(Long.parseLong(answer));
