...
public class RemoveFromCardCommandBlock extends CommandBlock {
    private final FurnitureService furnitureService;
    public RemoveFromCardCommandBlock(String command, String text, String answerText, UserState requiredUserStateForAnswer, FurnitureService furnitureService, InlineKeyboardButton... buttons) {
    ...
    public String handleAnswer(long chatId, UsersStateBlock userStatesBlock, String answer) {
        ...
        furnitureService.removeFromCartById(chatId, Long.parseLong(answer));
