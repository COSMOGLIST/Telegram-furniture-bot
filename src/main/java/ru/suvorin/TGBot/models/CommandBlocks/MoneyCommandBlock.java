...
public class MoneyCommandBlock extends CommandBlock {
    private final RequestService requestService;

    public MoneyCommandBlock(String command, String text, String answerText, UserState requiredUserStateForAnswer, RequestService requestService, InlineKeyboardButton... buttons) {
    ...
    public String handleAnswer(long chatId, UsersStateBlock userStatesBlock, String answer) {
        ...
        request.setMoney(Long.parseLong(answer));
