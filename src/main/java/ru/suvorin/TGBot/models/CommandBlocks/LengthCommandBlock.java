...
public class LengthCommandBlock extends CommandBlock {
    private final RequestService requestService;

    public LengthCommandBlock(String command, String text, String answerText, UserState requiredUserStateForAnswer, RequestService requestService, InlineKeyboardButton... buttons) {
    ...
    public String handleAnswer(long chatId, UsersStateBlock userStatesBlock, String answer) {
        ...
        request.setLength(Long.parseLong(answer));
