...
public class PurposeCommandBlock extends CommandBlock {
    private final RequestService requestService;

    public PurposeCommandBlock(String command, String text, String answerText, UserState requiredUserStateForAnswer, RequestService requestService, InlineKeyboardButton... buttons) {
